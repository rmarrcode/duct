...
// Command-line arguments: translate cs /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/db.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/duct.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/formic.specs.duct.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/join_training.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/landing_page.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/login_challenge.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/save_user.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/secure_page.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/implementations/user_info.program.dfy /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/formic.apis.duct.dfy --no-verify --allow-warnings --include-runtime --output /home/ryan-marr/Documents/secret/duct_env/duct/formic-backend/formic-specs/../formic-artifacts/converted-duct/formic_duct
// the_program
...
module Tools {
  ...
  trait {:termination false} IGeneratorCore extends IGeneratorSpec {
    ...
    ghost predicate ImplementationCorrect(u: UserInfo)
      decreases u
    {
      forall before: seq<DbValue> {:trigger Implementation(u, before)} :: 
        PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program))
    }

    method Generate(u: UserInfo, before: seq<DbValue>)
        returns (prog: DbProgram, payload: ReturnType)
...
module Specs {
    ...
    decreases n
  {
    if n < 10 then
      ...
      NatToString(n / 10) + DigitString(n % 10)
  }
...
module LoginImpl {
  ...
  class LoginChallengePage extends LoginChallengePageSpec {
    ...
    lemma /*{:_induction this}*/ ProveImplementationCorrect(u: UserInfo)
      ...
      decreases u
    {
      assert forall before: seq<DbValue> {:trigger Implementation(u, before)} :: PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program)) by {
        forall before: seq<DbValue> | true
          ensures PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program))
        {
      ...
      assert forall before: seq<DbValue> {:trigger Implementation(u, before)} :: PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program)) by {
          ...
          ensures PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program))
        {
          if u.authenticated && u.email != """" {
            ...
            assert ExecuteProgram(before, Implementation(u, before).program) == FilterEntries(before, PersistedUserKey(u.email)) + [row];
          } else {
            assert Implementation(u, before).response == ChallengeGoogle(""/save_user"");
            assert Implementation(u, before).program == Return;
            assert ProgramOperations(before, Implementation(u, before).program) == [];
...
module UserInfoImpl {
  ...
  class UserInfoPage extends UserInfoSpec {
    ...
    function Implementation(u: UserInfo, before: seq<DbValue>): GeneratedEndpointResult
      decreases u, before
    {
      GeneratedEndpointResult(Return, Content(NatToString(|before|)))
    }
      ...
      decreases u
    {
      assert forall before: seq<DbValue> {:trigger Implementation(u, before)} :: PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program)) by {
        forall before: seq<DbValue> | true
          ensures PostCondition(u, before, Implementation(u, before).response, ExecuteProgram(before, Implementation(u, before).program))
        {
          assert Implementation(u, before).response == Content(NatToString(|before|));
          assert Implementation(u, before).program == Return;
          assert ProgramOperations(before, Implementation(u, before).program) == [];
          assert ExecuteProgram(before, Implementation(u, before).program) == before;
        }
...
namespace Tools {
  ...
  public class UserInfo : _IUserInfo {
    ...
    public override bool Equals(object other) {
      var oth = other as Tools.UserInfo;
    ...
    public override string ToString() {
      string s = "Tools.UserInfo.UserInfo";
      s += "(";
      s += this._name.ToVerbatimString(true);
      s += ", ";
      s += this._email.ToVerbatimString(true);
    ...
    private static readonly Tools._IUserInfo theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, false);
    public static Tools._IUserInfo Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Tools._IUserInfo> _TYPE = new Dafny.TypeDescriptor<Tools._IUserInfo>(Tools.UserInfo.Default());
    public static Dafny.TypeDescriptor<Tools._IUserInfo> _TypeDescriptor() {
      return _TYPE;
    }
  ...
  public abstract class ReturnType : _IReturnType {
    ...
    private static readonly Tools._IReturnType theDefault = create_Content(Dafny.Sequence<Dafny.Rune>.Empty);
    public static Tools._IReturnType Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Tools._IReturnType> _TYPE = new Dafny.TypeDescriptor<Tools._IReturnType>(Tools.ReturnType.Default());
    public static Dafny.TypeDescriptor<Tools._IReturnType> _TypeDescriptor() {
      return _TYPE;
    }
  ...
  public class ReturnType_Content : ReturnType {
    ...
    public override bool Equals(object other) {
      var oth = other as Tools.ReturnType_Content;
    ...
    public override string ToString() {
      string s = "Tools.ReturnType.Content";
      s += "(";
  ...
  public class ReturnType_ChallengeGoogle : ReturnType {
    ...
    public override bool Equals(object other) {
      var oth = other as Tools.ReturnType_ChallengeGoogle;
    ...
    public override string ToString() {
      string s = "Tools.ReturnType.ChallengeGoogle";
      s += "(";
  ...
  public class ReturnType_Redirect : ReturnType {
    ...
    public override bool Equals(object other) {
      var oth = other as Tools.ReturnType_Redirect;
    ...
    public override string ToString() {
      string s = "Tools.ReturnType.Redirect";
      s += "(";
  ...
  public interface _IGeneratedEndpointResult {
    ...
    Tools._IReturnType dtor_response { get; }
  ...
  public class GeneratedEndpointResult : _IGeneratedEndpointResult {
    ...
    public readonly Tools._IReturnType _response;
    public GeneratedEndpointResult(DB._IDbProgram program, Tools._IReturnType response) {
    ...
    public override bool Equals(object other) {
      var oth = other as Tools.GeneratedEndpointResult;
    ...
    public override string ToString() {
      string s = "Tools.GeneratedEndpointResult.GeneratedEndpointResult";
      s += "(";
    ...
    private static readonly Tools._IGeneratedEndpointResult theDefault = create(DB.DbProgram.Default(), Tools.ReturnType.Default());
    public static Tools._IGeneratedEndpointResult Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Tools._IGeneratedEndpointResult> _TYPE = new Dafny.TypeDescriptor<Tools._IGeneratedEndpointResult>(Tools.GeneratedEndpointResult.Default());
    public static Dafny.TypeDescriptor<Tools._IGeneratedEndpointResult> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IGeneratedEndpointResult create(DB._IDbProgram program, Tools._IReturnType response) {
      return new GeneratedEndpointResult(program, response);
    }
    public static _IGeneratedEndpointResult create_GeneratedEndpointResult(DB._IDbProgram program, Tools._IReturnType response) {
    ...
    public Tools._IReturnType dtor_response {
      get {
  ...
  public interface IGeneratorSpec {
    bool PreCondition(Tools._IUserInfo u);
  }
  public class _Companion_IGeneratorSpec {
  }

  public interface IGeneratorCore : Tools.IGeneratorSpec {
    Tools._IGeneratedEndpointResult Implementation(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before);
    void Generate(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before, out DB._IDbProgram prog, out Tools._IReturnType payload);
  }
  public class _Companion_IGeneratorCore {
    public static void Generate(Tools.IGeneratorCore _this, Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before, out DB._IDbProgram prog, out Tools._IReturnType payload)
    {
      prog = DB.DbProgram.Default();
      payload = Tools.ReturnType.Default();
      Tools._IGeneratedEndpointResult _0_result;
      _0_result = (_this).Implementation(u, before);
  ...
  public partial class ApiEndpoint {
    public ApiEndpoint() {
      ...
      this.generator = default(Tools.IGeneratorCore);
    }
    public Dafny.ISequence<Dafny.Rune> apiUrl {get; set;}
    public Tools.IGeneratorCore generator {get; set;}
    public void __ctor(Dafny.ISequence<Dafny.Rune> apiUrl, Tools.IGeneratorCore generator)
    {
      (this).apiUrl = apiUrl;
      (this).generator = generator;
    }
  ...
  public partial class AllApiEndpoints {
    public AllApiEndpoints() {
      this.endpoints = Dafny.Sequence<Tools.ApiEndpoint>.Empty;
    }
    public Dafny.ISequence<Tools.ApiEndpoint> endpoints {get; set;}
    public void __ctor()
    {
      (this).endpoints = Dafny.Sequence<Tools.ApiEndpoint>.FromElements();
    }
    public void Add(Tools.ApiEndpoint ep)
    {
      (this).endpoints = Dafny.Sequence<Tools.ApiEndpoint>.Concat(this.endpoints, Dafny.Sequence<Tools.ApiEndpoint>.FromElements(ep));
    }
    ...
    public Tools.ApiEndpoint Get(BigInteger i)
    {
      Tools.ApiEndpoint ep = default(Tools.ApiEndpoint);
...
namespace Specs {
  ...
  public partial class __default {
    ...
    public static bool LandingPagePre(Tools._IUserInfo ctx) {
      return (((!((ctx).dtor_name).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) && (Specs.__default.IsValidUserInfoField((ctx).dtor_name))) && (Specs.__default.IsValidUserInfoField((ctx).dtor_email))) && (Specs.__default.IsValidUserInfoField((ctx).dtor_picture));
    }
    public static bool LandingPagePayloadPost(Tools._IUserInfo ctx, Tools._IReturnType payload)
    {
    ...
    public static bool LandingPagePost(Tools._IUserInfo ctx, Dafny.ISequence<DB._IDbValue> before, Tools._IReturnType payload, Dafny.ISequence<DB._IDbValue> after)
    {
      return (Specs.__default.LandingPagePayloadPost(ctx, payload)) && ((after).Equals(before));
    }
    public static bool LoginPost(Tools._IUserInfo ctx, Dafny.ISequence<DB._IDbValue> before, Tools._IReturnType payload, Dafny.ISequence<DB._IDbValue> after)
    {
      return (object.Equals(payload, Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/save_user")))) && ((after).Equals(before));
    }
    public static bool SecurePost(Tools._IUserInfo ctx, Dafny.ISequence<DB._IDbValue> before, Tools._IReturnType payload, Dafny.ISequence<DB._IDbValue> after)
    {
      return ((after).Equals(before)) && ((((ctx).dtor_authenticated) ? ((((payload).is_Content) && (SpecsTools.__default.Contains((payload).dtor_body, (ctx).dtor_name))) && (SpecsTools.__default.Contains((payload).dtor_body, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("You are authenticated")))) : (object.Equals(payload, Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/secure"))))));
    }
    public static bool SaveUserPost(Tools._IUserInfo ctx, Dafny.ISequence<DB._IDbValue> before, Tools._IReturnType payload, Dafny.ISequence<DB._IDbValue> after)
    {
      if (((ctx).dtor_authenticated) && (!((ctx).dtor_email).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))) {
        ...
        return (object.Equals(payload, Tools.ReturnType.create_Redirect(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/")))) && ((after).Equals(Dafny.Sequence<DB._IDbValue>.Concat(DB.__default.FilterEntries(before, DB.DbKey.create_PersistedUserKey((ctx).dtor_email)), Dafny.Sequence<DB._IDbValue>.FromElements(_0_row))));
      } else {
        return (object.Equals(payload, Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/save_user")))) && ((after).Equals(before));
      }
    }
    public static Dafny.ISequence<Dafny.Rune> DigitString(BigInteger d) {
      if ((d).Sign == 0) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("0");
      } else if ((d) == (BigInteger.One)) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("1");
      } else if ((d) == (new BigInteger(2))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("2");
      } else if ((d) == (new BigInteger(3))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("3");
      } else if ((d) == (new BigInteger(4))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("4");
      } else if ((d) == (new BigInteger(5))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("5");
      } else if ((d) == (new BigInteger(6))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("6");
      } else if ((d) == (new BigInteger(7))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("7");
      } else if ((d) == (new BigInteger(8))) {
    ...
    TAIL_CALL_START: ;
      if ((n) < (new BigInteger(10))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(Specs.__default.DigitString(n), _0___accumulator);
      } else {
        _0___accumulator = Dafny.Sequence<Dafny.Rune>.Concat(Specs.__default.DigitString(Dafny.Helpers.EuclideanModulus(n, new BigInteger(10))), _0___accumulator);
  ...
  public interface LandingPageSpec : Tools.IGeneratorCore, Tools.IGeneratorSpec {
  }
  public class _Companion_LandingPageSpec {
    public static bool PreCondition(Specs.LandingPageSpec _this, Tools._IUserInfo u) {
      return Specs.__default.LandingPagePre(u);
    }
  }

  public interface LoginChallengePageSpec : Tools.IGeneratorCore, Tools.IGeneratorSpec {
  }
  public class _Companion_LoginChallengePageSpec {
    public static bool PreCondition(Specs.LoginChallengePageSpec _this, Tools._IUserInfo u) {
      return true;
    }
  }

  public interface SaveUserPageSpec : Tools.IGeneratorCore, Tools.IGeneratorSpec {
  }
  public class _Companion_SaveUserPageSpec {
    public static bool PreCondition(Specs.SaveUserPageSpec _this, Tools._IUserInfo u) {
      return true;
    }
  }

  public interface SecurePageSpec : Tools.IGeneratorCore, Tools.IGeneratorSpec {
  }
  public class _Companion_SecurePageSpec {
    public static bool PreCondition(Specs.SecurePageSpec _this, Tools._IUserInfo u) {
      return true;
    }
  }

  public interface UserInfoSpec : Tools.IGeneratorCore, Tools.IGeneratorSpec {
  }
  public class _Companion_UserInfoSpec {
    public static bool PreCondition(Specs.UserInfoSpec _this, Tools._IUserInfo u) {
      return true;
    }
  }
} // end of namespace Specs
namespace LandingImpl {

  public partial class __default {
    public static Dafny.ISequence<Dafny.Rune> LandingPageStatus(Tools._IUserInfo ctx) {
    ...
    public static Dafny.ISequence<Dafny.Rune> LandingPageAction(Tools._IUserInfo ctx) {
      if ((ctx).dtor_authenticated) {
        return Dafny.Sequence<Dafny.Rune>.Concat(SpecsTools.__default.Link(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("User Info"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/user_info")), SpecsTools.__default.Link(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Log out"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/logout")));
      } else {
    ...
    public static Dafny.ISequence<Dafny.Rune> LandingPagePicturePanel(Tools._IUserInfo ctx) {
    ...
    public static Dafny.ISequence<Dafny.Rune> LandingPageEmailPanel(Tools._IUserInfo ctx) {
    ...
    public static Dafny.ISequence<Dafny.Rune> LandingPagePictureMeta(Tools._IUserInfo ctx) {
      if (((ctx).dtor_picture).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) {
...
namespace LoginImpl {
  ...
  public partial class LoginChallengePage : Specs.LoginChallengePageSpec, Tools.IGeneratorCore, Tools.IGeneratorSpec {
    ...
    public Tools._IGeneratedEndpointResult Implementation(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before)
    {
      return Tools.GeneratedEndpointResult.create(DB.DbProgram.create_Return(), Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/save_user")));
    }
  }
} // end of namespace LoginImpl
namespace SaveUserImpl {


  public partial class SaveUserPage : Specs.SaveUserPageSpec, Tools.IGeneratorCore, Tools.IGeneratorSpec {
    public SaveUserPage() {
    }
    public void Generate(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before, out DB._IDbProgram prog, out Tools._IReturnType payload)
    {
      DB._IDbProgram _out4;
      Tools._IReturnType _out5;
      Tools._Companion_IGeneratorCore.Generate(this, u, before, out _out4, out _out5);
      prog = _out4;
      payload = _out5;
    }
    public bool PreCondition(Tools._IUserInfo u) {
      return Specs._Companion_SaveUserPageSpec.PreCondition(this, u);
    }
    public void __ctor()
    {
    }
    public Tools._IGeneratedEndpointResult Implementation(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before)
    {
      if (((u).dtor_authenticated) && (!((u).dtor_email).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))) {
        return Tools.GeneratedEndpointResult.create(DB.DbProgram.create_Insert(DB.DbValue.create_DbPersistedUser(DB.PersistedUser.create((u).dtor_email, (u).dtor_name, (u).dtor_picture))), Tools.ReturnType.create_Redirect(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/")));
      } else {
        return Tools.GeneratedEndpointResult.create(DB.DbProgram.create_Return(), Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/save_user")));
      }
    }
  }
} // end of namespace SaveUserImpl
namespace SecureImpl {

  public partial class __default {
    public static Dafny.ISequence<Dafny.Rune> SecureHtml(Tools._IUserInfo ctx) {
  ...
  public partial class SecurePage : Specs.SecurePageSpec, Tools.IGeneratorCore, Tools.IGeneratorSpec {
    public SecurePage() {
    }
    public void Generate(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before, out DB._IDbProgram prog, out Tools._IReturnType payload)
    {
      DB._IDbProgram _out6;
      Tools._IReturnType _out7;
      Tools._Companion_IGeneratorCore.Generate(this, u, before, out _out6, out _out7);
      prog = _out6;
      payload = _out7;
    }
    public bool PreCondition(Tools._IUserInfo u) {
      return Specs._Companion_SecurePageSpec.PreCondition(this, u);
    }
    public void __ctor()
    {
    }
    public Tools._IGeneratedEndpointResult Implementation(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before)
    {
      return Tools.GeneratedEndpointResult.create(DB.DbProgram.create_Return(), (((u).dtor_authenticated) ? (Tools.ReturnType.create_Content(SecureImpl.__default.SecureHtml(u))) : (Tools.ReturnType.create_ChallengeGoogle(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/secure")))));
    }
  }
} // end of namespace SecureImpl
namespace UserInfoImpl {


  public partial class UserInfoPage : Specs.UserInfoSpec, Tools.IGeneratorCore, Tools.IGeneratorSpec {
    public UserInfoPage() {
    }
    public void Generate(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before, out DB._IDbProgram prog, out Tools._IReturnType payload)
    {
      DB._IDbProgram _out8;
      Tools._IReturnType _out9;
      Tools._Companion_IGeneratorCore.Generate(this, u, before, out _out8, out _out9);
      prog = _out8;
      payload = _out9;
    }
    public bool PreCondition(Tools._IUserInfo u) {
      return Specs._Companion_UserInfoSpec.PreCondition(this, u);
    }
    public void __ctor()
    {
    }
    public Tools._IGeneratedEndpointResult Implementation(Tools._IUserInfo u, Dafny.ISequence<DB._IDbValue> before)
    {
      return Tools.GeneratedEndpointResult.create(DB.DbProgram.create_Return(), Tools.ReturnType.create_Content(Specs.__default.NatToString(new BigInteger((before).Count))));
    }
  }
} // end of namespace UserInfoImpl
namespace DuctApis {
  ...
  public partial class Views {
    ...
    public static Tools.AllApiEndpoints Endpoints()
    {
      Tools.AllApiEndpoints all = default(Tools.AllApiEndpoints);
      Tools.AllApiEndpoints _0_catalog;
      Tools.AllApiEndpoints _nw0 = new Tools.AllApiEndpoints();
      _nw0.__ctor();
      _0_catalog = _nw0;
      LandingImpl.FormicLandingPage _1_formic__landing;
      LandingImpl.FormicLandingPage _nw1 = new LandingImpl.FormicLandingPage();
      _nw1.__ctor();
      _1_formic__landing = _nw1;
      Tools.ApiEndpoint _2_home;
      Tools.ApiEndpoint _nw2 = new Tools.ApiEndpoint();
      _nw2.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/"), _1_formic__landing);
      _2_home = _nw2;
      (_0_catalog).Add(_2_home);
      LoginImpl.LoginChallengePage _3_login__page;
      LoginImpl.LoginChallengePage _nw3 = new LoginImpl.LoginChallengePage();
      _nw3.__ctor();
      _3_login__page = _nw3;
      Tools.ApiEndpoint _4_login;
      Tools.ApiEndpoint _nw4 = new Tools.ApiEndpoint();
      _nw4.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/login"), _3_login__page);
      _4_login = _nw4;
      (_0_catalog).Add(_4_login);
      SaveUserImpl.SaveUserPage _5_save__user__page;
      SaveUserImpl.SaveUserPage _nw5 = new SaveUserImpl.SaveUserPage();
      _nw5.__ctor();
      _5_save__user__page = _nw5;
      Tools.ApiEndpoint _6_save__user;
      Tools.ApiEndpoint _nw6 = new Tools.ApiEndpoint();
      _nw6.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/save_user"), _5_save__user__page);
      _6_save__user = _nw6;
      (_0_catalog).Add(_6_save__user);
      SecureImpl.SecurePage _7_secure__page;
      SecureImpl.SecurePage _nw7 = new SecureImpl.SecurePage();
      _nw7.__ctor();
      _7_secure__page = _nw7;
      Tools.ApiEndpoint _8_secure;
      Tools.ApiEndpoint _nw8 = new Tools.ApiEndpoint();
      _nw8.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/secure"), _7_secure__page);
      _8_secure = _nw8;
      (_0_catalog).Add(_8_secure);
      UserInfoImpl.UserInfoPage _9_user__info__page;
      UserInfoImpl.UserInfoPage _nw9 = new UserInfoImpl.UserInfoPage();
      _nw9.__ctor();
      _9_user__info__page = _nw9;
      Tools.ApiEndpoint _10_user__info;
      Tools.ApiEndpoint _nw10 = new Tools.ApiEndpoint();
      _nw10.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/user_info"), _9_user__info__page);
      _10_user__info = _nw10;
      (_0_catalog).Add(_10_user__info);
      all = _0_catalog;
      return all;
    }
  }
