// Dafny program Demo1.dfy compiled into C#
...
// Command-line arguments: build --target cs --output Demo1-custom Demo1.dfy Demo.cs
// Demo1.dfy
...
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => M.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
